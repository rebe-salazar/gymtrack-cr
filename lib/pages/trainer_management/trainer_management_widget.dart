...
import 'trainer_management_model.dart';
export 'trainer_management_model.dart';

class TrainerManagementWidget extends StatefulWidget {
  const TrainerManagementWidget({super.key});

  static String routeName = 'TrainerManagement';
  static String routePath = '/trainerManagement';

  @override
  State<TrainerManagementWidget> createState() =>
      _TrainerManagementWidgetState();
}

class _TrainerManagementWidgetState extends State<TrainerManagementWidget> {
  late TrainerManagementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrainerManagementModel());
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Entrenador seleccionado correctamente',
                                        style: TextStyle(
