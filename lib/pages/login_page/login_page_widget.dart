...
class _LoginPageWidgetState extends State<LoginPageWidget> {
  ...
  void initState() {
    ...
    _model.txtCorreoLoginTextController ??= TextEditingController();
    _model.txtCorreoLoginFocusNode ??= FocusNode();

    _model.txtContrasenaLoginTextController ??= TextEditingController();
    _model.txtContrasenaLoginFocusNode ??= FocusNode();
  }
                                                    ...
                                                    children: [
                                                      Expanded(
                                                        child: Container(
                                                          ...
                                                          child: TextFormField(
                                                            controller: _model
                                                                .txtCorreoLoginTextController,
                                                            focusNode: _model
                                                                .txtCorreoLoginFocusNode,
                                                            autofocus: false,
                                                            enabled: true,
                                                            obscureText: false,
                                                            decoration:
                                                    ...
                                                    children: [
                                                      Expanded(
                                                        child: Container(
                                                          ...
                                                          child: TextFormField(
                                                            controller: _model
                                                                .txtContrasenaLoginTextController,
                                                            focusNode: _model
                                                                .txtContrasenaLoginFocusNode,
                                                            autofocus: false,
                                                            enabled: true,
                                                            obscureText: !_model
                                                                .txtContrasenaLoginVisibility,
                                                            decoration:
                                                                InputDecoration(
                                                              isDense: true,
                                                              labelStyle:
                                                              ...
                                                              suffixIcon:
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  safeSetState(() =>
                                                                      _model.txtContrasenaLoginVisibility =
                                                                          !_model
                                                                              .txtContrasenaLoginVisibility);
                                                                },
                                                                focusNode: FocusNode(
